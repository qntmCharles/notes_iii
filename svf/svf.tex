...
\begin{align}
	\symbf{f}_s &= \symsf{\sigma}_1 \cdot \symbf{n} - \symsf{\sigma}_2 \cdot
	\symbf{n} \\
...
\cdot \nabla_s C'$ have been neglected. This is a linear problem in the rise
velocity $\symbf{U}$ and from spherical symmetry
\begin{equation}
	\symbf{u}_s = A \left( \symsf{I} - \symbf{n}\symbf{n}\right)\cdot\symbf{U}
\end{equation}
for some $A$. To calculate $\nabla_s \cdot \symbf{u}_s$, note
\begin{align}
...
(fast diffusion) or $\frac{U}{ka} \ll 1$ (fast absorption). The problem is
completed by using a Papkovich-Neuber representation inside and outside with
boundary conditions
\begin{align}
	\symbf{u} \to -\symbf{U} \,\,\, \text{as}\,\,\, &r \to \infty \\
	\symbf{u} \,\,\,\text{finite at} \,\,\, &r = 0 \\
	\symbf{u}= \symbf{u}_s \,\,\, \text{at} \,\,\, &r = a^+_-\\
	\left[\symbf{n} \times \symsf{\sigma}\cdot\symbf{n}\right]^+_- =
