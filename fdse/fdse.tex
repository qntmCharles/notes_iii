...
\begin{align}
	N &= \int_{h-H}^h \symsf{\sigma}_{xx} \, \diffd z \\
	  &= -\frac{1}{2}\rho g H^2 + 4\mu H \frac{\partial u}{\partial x}
\end{align}
...
\begin{align}
	...
	Hu &= q_G
\end{align}
where the first specifies the thickness of the shelf at the grounding line and
the second enforces a constant flux into the ice shelf.
