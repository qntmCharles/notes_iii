...
The rise of the fluid parcel releases potential energy $E$ which scales as
\begin{equation}
...
Note that typically we define $\text{Ra}$ in terms of a thermal gradient. Then
$\beta = \rho_0^{-1}\frac{\diffd \rho}{\diffd z} \sim \alpha \Delta T / L$ and
\begin{equation}
	\text{Ra} = \frac{\rho_0 \alpha g \Delta T L^3}{\kappa \mu}
\end{equation}
...
\begin{align}
	...
	\alpha}{\kappa\mu}\right)^{1/3} \Delta T^{4/3}
\end{align}
...
\begin{equation}
	4\pi R_0^2 F_m = \frac{4\pi}{3}\left[ R_o^3 - R_i^3\right] \rho c_p
...
case,
\begin{equation}
	4\pi R_o^2 F_m = \frac{4\pi}{3} R_o^3 \rho c_p \cdot \frac{4\pi}{3}
...
\begin{equation}
	m = \frac{2}{9} R_o^3 \rho c_p \frac{G T_m \delta \rho}{L}
\end{equation}
...
\section{Solidification of binary eutectic mixtures}
...
\begin{center}
	\begin{tikzpicture}
		...
		\draw[red] (8.7, 1) node[right] {\small $T_L(C)$};
		\draw[red,->] (8.7, 1) -- (8, 1.7);
...
\begin{enumerate}
	...
	\item All impurities are accomodated within the mushy layer, i.e. $C =
		C_0$ for $x > b(t)$.
	\item Linear liquidus approximation
		\begin{equation}
			T_L = T_0 - m(C-C_0)
		\end{equation}
...
\begin{center}
	\begin{tikzpicture}
		\draw[thick] (0,0) -- (5, 0) node[right] {$z=h$};
		\draw[thick] (0, 2) -- (5, 2) node[right] {$z=0$};
		 \draw[red] (2.5, 0) node[below] {$T_0$};
		 \draw[red] (2.5, 2) node[above] {$T_B$};
	\end{tikzpicture}
\end{center}
...
\begin{center}
	\begin{tikzpicture}
		\draw[thick] (0,0) -- (5, 0) node[right] {$z=h$};
		\draw[thick] (0, 2) -- (5, 2) node[right] {$z=0$};
		\draw[red,->] (0.1, 0) arc (180:90:1.2);
		\draw[red] (1.3, 1.2) arc (90:0:1.2);
		\draw[red,->] (0.5, 0) arc (180:90:0.8);
		\draw[red] (1.3, 0.8) arc (90:0:0.8);
		\draw[red,->] (4.9, 0) arc (0:90:1.2);
		\draw[red] (3.7, 1.2) arc (90:180:1.2);
		\draw[red,->] (4.5, 0) arc (0:90:0.8);
		\draw[red] (3.7, 0.8) arc (90:180:0.8);
	\end{tikzpicture}
\end{center}
...
\begin{center}
	\begin{tikzpicture}
		\draw[red] (0,0) -- (3,  -5);
		\draw[red] (0,0) node[left] {$T$};
		\draw[red] (3, 0) node[right] {cold};
		\draw[red] (3, -5) node[right] {warm};
		\draw[purple,fill] (1, -5/3) circle (0.05);
		\draw[purple,fill] (1, -4) circle (0.05);
		\draw[purple,fill] (2.4, -4) circle (0.05);
		\draw[purple] (1, -5/3) -- (1, -4) -- (2.4, -4);
		\draw[purple] (1, -5/3) node[left] {1};
		\draw[purple] (1, -4) node[left] {2};
		\draw[purple] (2.4, -4) node[right] {3};
		\draw[blue] (10,0) -- (7, -5);
		\draw[blue] (10,0) node[right] {$C$};
		\draw[blue] (7, 0) node[left] {salty};
		\draw[blue] (7, -5) node[left] {fresh};
		\draw[purple,fill] (9, -5/3) circle (0.05);
		\draw[purple,fill] (9, -4) circle (0.05);
		\draw[purple,fill] (8, -4) circle (0.05);
		\draw[purple] (9, -5/3) -- (9, -4) -- (8, -4);
		\draw[purple] (9, -5/3) node[right] {1};
		\draw[purple] (9, -4) node[right] {2};
		\draw[purple] (8, -4) node[left] {3};
	\end{tikzpicture}
\end{center}
...
\begin{center}
	\begin{tikzpicture}
		...
		\draw[blue,smooth] plot[domain=-1.5:1.5] ({\x},{4+0.1*sin(4*2*pi/3*deg(\x))});
		\draw[dashed] (-1.5, 2) -- (1.5, 2) node[right] {$z=h$};
		\draw (1.5, 0) node[right] {$z=0$};
		\draw (1.5, 1) node[right] {porous medium};
		\draw (1.5, 3) node[right] {fluid};
		\draw[red,smooth] plot[tension=0.5] coordinates {(-0.5, 2) (-0.4, 1.5) (0, 0.5) (0.5, 0)};
		\draw[red] (0.5, 1) node {$\phi(z)$};
	\end{tikzpicture}
\end{center}
...
\begin{center}
	\begin{tikzpicture}
		...
		\draw (1.5, 3) node[right] {fluid};
		\draw[red,smooth] plot[tension=0.5] coordinates {(-0.5, 2) (-0.4, 1.5) (0, 0.5) (0.5, 0)};
		\draw[red] (0.5, 1) node {$\phi(z,t)$};
		\draw[thick,->] (0, 0.2) -- (0, -0.8) node[right] {$Q$};
	\end{tikzpicture}
\end{center}
...
\begin{align}
	...
	\right]
\end{align}
but for typical values deformation is small, $h \ll H$, hence
\begin{equation}
	\frac{\partial h}{\partial t} \approx \frac{\Pi E}{\mu_f} \frac{\partial^2
	h}{\partial x^2}\label{eq:l14:4}
\end{equation}
Stress balance at the top surface is
\begin{align}
	-p + \hat{\symbf{z}}\cdot\symsf{\sigma}_e \cdot \hat{\symbf{z}} &= -p_0 \\
	-p + E\frac{\phi_0-\phi}{\phi_0} &= -p_0 \\
	p-p_0 &= E\frac{\phi_0-\phi}{\phi_0} = E\frac{h}{H}\label{eq:l14:5}
\end{align}
where $p_0$ is the \emph{overburden pressure}. Combining \eqref{eq:l14:4} and
\eqref{eq:l14:5} gives
\begin{equation}
	\frac{\partial p}{\partial t} = \frac{\Pi E}{\mu_f} \frac{\partial^2
	p}{\partial x^2}
\end{equation}

\section{Ice sheets}
\subsection{Terrestrial ice sheets}
In this section we consider ice sheets lying over land (e.g. Greenland). Ice
sheets are fed by snowfall at high latitudes and are terminated on land by
surface melting/ablation. They flow as a viscous current on timescales longer
than months.

\subsubsection{Two dimensional model}
Consider a two dimensional model of an ice sheet with a uniform (flat)
bedrock. We consider a region between the \emph{ice divide} $x=0$ where ice
separates and the \emph{nose} $x=x_N$ where the ice sheet terminates.

\begin{center}
	\begin{tikzpicture}[scale=1.6]
		\draw[thick] (0,0) -- (5, 0) node[right] {$x$};
		\draw[blue,smooth] plot coordinates {(0, 1) (2, 0.9) (3, 0.7) (3.7,
		0.4) (4, 0)};
		\draw[dashed] (0,0) -- (0, 1.5);
		\draw[red,dashed] (3,0) -- (3, 1.5);
		\draw[red, smooth] plot[tension=0.8] coordinates {(3.1, 0) (3.25, 0.3) (3.3, 0.6)};
		\draw[red] (3.1,0) node[below] {$u_b$};
		\draw[red] (3.1, 0.7) node[right] {$u(x,z,t)$};
		\draw (0,0) node[below] {$x=0$};
		\draw (0,1.5) node[above] {ice divide};
		\draw (4, 0) node[below] {$x=x_N$};
		\draw[blue,snake it,->] (2, 2) -- (2, 1) node[midway,right] {$a$};
		\draw[blue,snake it,->] (4.2, 0.2) -- (4.2, 1.2) node[midway,right] {$a$};
		\draw[dashed] (0, 0.8) -- (5, 0.8) node[right] {$h=h_s$};
	\end{tikzpicture}
\end{center}
...
\begin{enumerate}
	\item No ablation, $a_N = 0$: only one possible balance
		...
		\begin{center}
			\begin{tikzpicture}
				\draw[thick] (0,0) -- (5,0);
				\draw[blue,smooth] plot[domain=0:4,samples=100] ({\x},{(4-\x)^(1/3)});
			\end{tikzpicture}
		\end{center}
			...
			\item retreating nose $h_t < 0$: system is again unbalanced if we
				...
				\begin{center}
					\begin{tikzpicture}
						...
						\draw[->] (0,0.5) -- (1, 0.5)
						node[midway,above] {$q$};
						\draw[->] (4.5, -0.2) -- (3.5, -0.2)
						node[midway,below] {$\dot{x}_N$};
						\draw[snake it, ->] (4, 0.2) -- (4, 1.2)
						node[midway,right] {$a_N$};
					\end{tikzpicture}
				\end{center}
		\end{enumerate}
\end{enumerate}

\subsection{Marine ice sheets}
Marine ice sheets sit on bedrock below sea level and detach (i.e. float) at
the \emph{grounding line} to form an ice shelf. 
\begin{center}
	\begin{tikzpicture}
		\draw[thick,->] (0,0) -- (10, 0) node[right] {$x$};
		\draw[blue,smooth] plot[tension=.8] coordinates {(4,0) (5, 0.5) (6,
		0.7) (7, 0.8) (8, 0.85)};
		\draw[blue] (8, 0.85) -- (8, 1.1);
		\draw[blue,smooth] plot[tension=.8] coordinates {(8, 1.1) (7, 1.13)
		(6, 1.16) (5, 1.2) (4, 1.3) (3, 1.6) (2, 1.85) (1, 1.9) (0, 1.92)};
		\draw (4, 0) -- (4, -0.1) node[below] {$x_G(t)$};
		\draw (8, 0) -- (8, -0.1) node[below] {$x_N(t)$};
		\draw (6, 2) node {ice shelf};
		\draw (2, 2.2) node {ice sheet};
		\draw[blue,dashed] (0, 1) -- (10, 1);
		\draw (10, 1.2) node {sea};
		\draw (10, 0.8) node {level};
		\draw (0,1) node[left] {$z=0$};
		\draw[red,dashed] (1, 0) -- (1, 1.9);
		\draw[red,smooth] plot[tension=0.8] coordinates {(1.1, 0) (1.2, 0.2) (1.5, 1)
		(1.6, 1.9)};
		\draw[red,->] (1, 0.5) -- (1.335, 0.5);
		\draw[red,->] (1, 1) -- (1.5, 1); 
		\draw[red,->] (1, 1.5) -- (1.57, 1.5); 
		\draw[red,dashed] (6, 0.7) -- (6, 1.16);
		\draw[red] (6.5, 0.75) -- (6.5, 1.145);
		\draw[red,->] (6, 0.85) -- (6.5, 0.85);
		\draw[red,->] (6, 1.05) -- (6.5, 1.05);
		\draw[<->] (5, 1.2) -- (5, 0.5) node[midway,left] {$H$};
		\draw (5, 0.4) node[right] {$z = -b(x,t)$};
		\draw (5, 1.4) node[right] {$z = h(x,t)$};
		\draw (3, 0.5) node {$\rho$};
		\draw (9, 0.5) node {$\rho_w > \rho$};
	\end{tikzpicture}
\end{center}

We model the ice shelf as extensional flow with an almost uniform profile and
total ice depth $H = h+b$ with height $h(x,t)$ above sea level and depth
$-b(x,t)$ below sea level. The ice shelf has density $\rho$ and the
surrounding water has depth $\rho_w > \rho$, hence the shelf floats.

\subsubsection{Ice shelf height}
Ignore bending moments and apply Archimedean buoyancy to find the height above
sea level: weight of the ice shelf must balance the buoyant force
provided by the surrounding water.
\begin{align}
	\rho g H &= \rho_w g (H-h) \\
	\implies h &= \frac{g'}{g}H
	\label{eq:flotation}
\end{align}
where $g' = \frac{\rho_w - \rho}{\rho_w}g$ is the \emph{reduced gravity}. Note
that typically $h \sim H/7$. The result \eqref{eq:flotation} may be referred
to as the \emph{flotation condition}.
...
\begin{center}
	\begin{tikzpicture}
		\draw[dashed] (0,0) -- (5, 0) node[right] {$z=0$};
		\draw[blue,smooth] plot[tension=0.8] coordinates {(0,-2) (1.5, -1.5) (3,
		-1.2) (5, -1)};
		\draw[blue,smooth] plot[tension=0.8] coordinates {(0, 0.7) (2, 0.5)
		(5, 0.4)};
		\draw[thick,->] (0, -0.5) -- (1, -0.5);
		\draw (0, -0.5) node[left] {$N(x)$};
		\draw[blue,dashed] (1, -2) -- (1, 1);
		\draw[blue,dashed] (4, -2) -- (4, 1);
		\draw[thick,->] (4, -0.5) -- (5, -0.5) node[right] {$N(x+\delta x)$};
		\draw (2.5, 0.8) node {$p_0$};
		\draw (2.5, 1.6) node {atmospheric};
		\draw (2.5, 1.2) node {pressure};
		\draw (2.5, -1.8) node {$p_0 + \rho_w g b$};
		\draw (2.5, -2.2) node {hydrostatic};
		\draw (2.5, -2.6) node {pressure};
	\end{tikzpicture}
\end{center}
...
\begin{center}
	\begin{tikzpicture}
		\draw[blue,thick,smooth, name path = A] plot[tension=0.8] coordinates {(0,-2)
		(1.5, -1.5) (3, -1.2) (5, -1)};
		\draw[blue,thick,smooth, name path = B] plot[tension=0.8] coordinates {(0,
		0.7) (1.5, 0.54) (4.5, 0.42) (5, 0.4)};
		\tikzfillbetween[of=A and B, soft clip={(0.5, 3) rectangle (1.5, -3)}]{blue!20};
		\tikzfillbetween[of=A and B, soft clip={(2.5, 3) rectangle (4.5, -3)}]{blue!20};
		\draw[blue,thick] (1.5, -1.5) -- (1.5, 0.54);
		\draw[blue,thick] (0.5, -1.82) -- (0.5, 0.64);
		\draw[blue,thick] (2.5, -1.27) -- (2.5, 0.5);
		\draw[blue,thick] (4.5, -1.05) -- (4.5, 0.42);
		\draw[dashed] (0,0) -- (5, 0) node[right] {$z=0$};
		\draw[very thick,->] (1.7, -0.5) -- (2.3, -0.5);
		\draw[blue,thick,smooth] plot[tension=0.8] coordinates {(0,-2)
		(1.5, -1.5) (3, -1.2) (5, -1)};
		\draw[blue,thick,smooth] plot[tension=0.8] coordinates {(0,
		0.7) (1.5, 0.54) (4.5, 0.42) (5, 0.4)};
		\draw (5,-1) node[right] {profile $H(x)$};
	\end{tikzpicture}
\end{center}
...
\begin{itemize}
	\item \textbf{Prograde slope}: if $x_G$ advances, $H$ increases, hence $q
		...
		\begin{center}
			\begin{tikzpicture}
				\draw[draw=none,fill=gray!40,rotate=-22] (0,0) rectangle (5.4, -0.2);
				\draw[thick] (0,0) -- (5, -2);
				\draw[dashed] (0,0) -- (5, 0);
				\draw[blue] (1,1) -- (3, 0.2) -- (3, -1.2);
			\end{tikzpicture}
		\end{center}
...
\begin{center}
	\begin{tikzpicture}
		\draw (0, 3) node[right] {top view};
		\draw[blue,thick] (0, 0) -- (5, 0) node[right] {$y=0$};
		\draw[blue,thick] (0, 2) -- (5, 2) node[right] {$y=W$};
		\draw[dashed] (1.5, 2.5) -- (1.5, -0.5);
		\draw (1.75, -0.5) node[below] {$x_G$};
		\draw[dashed] (2, 2.5) -- (2, -0.5);
		\draw[blue,dashed] (0.5, 0) -- (0.5, 2);
		\draw[blue,dashed] (4, 0) -- (4, 2);
		\draw[blue,smooth] plot[domain=-1:1,samples=100]
		({0.5+0.5*(1-\x*\x*\x*\x*\x*\x*\x*\x)},{1+\x});
		\draw[blue,->] (0.5, 1.5) -- (1, 1.5);
		\draw[blue,->] (0.5, 1) -- (1, 1);
		\draw[blue,->] (0.5, 0.5) -- (1, 0.5);
		\draw[blue,smooth] plot[domain=-1:1,samples=100] ({4.5-0.5*\x*\x},{1+\x});
		\draw[blue,->] (4, 1.5) -- (4.375, 1.5);
		\draw[blue,->] (4, 1) -- (4.5, 1);
		\draw[blue,->] (4, 0.5) -- (4.375, 0.5);
	\end{tikzpicture}
\end{center}
